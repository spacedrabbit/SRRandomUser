...
/** Random user request. Requests a specified quantity and gender of users of any nationality, formatted as JSON
 *  @param quantity The number of users to request
 *  @param gender The gender of the random users, defaults to @p SRRandomUserGenderAny
 *  @param completion @p SRRandomUserCompletionBlock completion block @p (void)^(SRRandomUserPool *, BOOL success)
 *  @remarks @p completion provides access to the random user pool. Be sure to first check that @p success is @p YES
 */
...
/** Random user request. Requests a specified quantity, gender, and nationality of users, formatted as JSON
 *  @param quantity The number of users to request
 *  @param gender The gender of the random users, defaults to @p SRRandomUserGenderAny
 *  @param nationality The nationality of the users, defaults to @p SRRandomUserNationalityAll
 *  @param completion @p SRRandomUserCompletionBlock completion block @p (void)^(SRRandomUserPool *, BOOL success)
 *  @remarks @p completion provides access to the random user pool. Be sure to first check that @p success is @p YES
 */
...
/** Request for all of the random users generated by an @p SRRandomUserPool @p seed property
 *  @param seed The seed value to request
 *  @param completion @p SRRandomUserCompletionBlock completion block @p (void)^(SRRandomUserPool *, BOOL success)
 *  @sa -(NSString *)seedForPool:(SRRandomUserPool *)pool
 */
